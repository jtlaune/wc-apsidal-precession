...
# Uniform in epvals
epvals = npy.random.default_rng(seed=389).uniform(5e-3, 0.1, N_jobs)

# Log uniform in ompvals
ompvals = npy.power(
    10, npy.random.default_rng(seed=679).uniform(npy.log10(5e-6), -3, N_jobs)
)

# Uniform in thetap0vals
thetap0vals = npy.random.default_rng(seed=12890).uniform(0, 2 * npy.pi, N_jobs)
